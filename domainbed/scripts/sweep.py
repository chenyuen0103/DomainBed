...
if __name__ == "__main__":
    ...
    parser.add_argument('--output_dir', default= '/projects/bdmr/chenyuen0103/domainbed/results_resnet_uai',type=str, required=True)
    parser.add_argument('--data_dir', default = '/projects/bdmr/chenyuen0103/domainbed/datasets' ,type=str, required=True)
